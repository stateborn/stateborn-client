...
export interface ERC20DaoPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approveProposal"
      | "approvedProposals"
...
export interface ERC20DaoPool extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20DaoPool;
  waitForDeployment(): Promise<this>;

  interface: ERC20DaoPoolInterface;
  ...
  withdraw: TypedContractMethod<
    [amount: BigNumberish, withdrawAddress: AddressLike],
    [void],
    "nonpayable"
  >;
