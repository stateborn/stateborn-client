...
export interface ERC20DaoFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createDao"
...
export interface ERC20DaoFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20DaoFactory;
  waitForDeployment(): Promise<this>;

  interface: ERC20DaoFactoryInterface;
